...
public class AccountsController(AppDbContext context, ITokenService tokenService):BaseController
{
    [HttpPost("register")]
    ...
    public async Task<ActionResult<UserDto>> Login(LoginDto loginDto)
    {
        ...
        {
            if (hashedPassword[i] != user.PasswordHash[i]) return Unauthorized("Could not validate user");
        }
